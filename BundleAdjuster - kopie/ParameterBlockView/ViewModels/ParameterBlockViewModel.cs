...
namespace BundleAdjuster.ParameterBlockView.ViewModels
{
    ...
    public class ParameterBlockViewModel: Tool, INotifyPropertyChanged {
        ...
        public IEnumerable<Enum> FlagTypes {
            get { return Util.GetFlagTypesForParamblock(); }
        }

        public ICeresParameterblock Block => _block;

        public Object Flags => "Not implemented";
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ivm.ParameterblockSelected += ParameterblockSelected;
            gcpvm.ParameterblockSelected += ParameterblockSelected;
            cvm.ParameterblockSelected += ParameterblockSelected;*/
        }
